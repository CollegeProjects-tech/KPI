...
@Component({
  selector: 'app-internal-revnu-gen',
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule],
  templateUrl: './internal-revnu-gen.component.html',
  styleUrl: './internal-revnu-gen.component.css'
})
export class InternalRevnuGenComponent implements OnInit{
  ...
  load(){
    ...
    this.api.get('Int_rev_generate/Int_rev_genrates').subscribe((res:any)=>{
      this.Int_rev_genrates=res;
      console.log(res)
    })
