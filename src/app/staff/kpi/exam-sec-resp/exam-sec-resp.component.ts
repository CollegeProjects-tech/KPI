...
@Component({
  selector: 'app-exam-sec-resp',
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule],
  templateUrl: './exam-sec-resp.component.html',
  styleUrl: './exam-sec-resp.component.css'
})
export class ExamSecRespComponent implements OnInit {
  ...
  load(){
    ...
    this.api.get('Exam_sec_respo/Exam_sec_res').subscribe((res:any)=>{
      this.Exam_sec_res=res;
      console.log(res)
    })
