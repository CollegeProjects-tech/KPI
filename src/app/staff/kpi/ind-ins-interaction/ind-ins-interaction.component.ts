...
@Component({
  selector: 'app-ind-ins-interaction',
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule],
  templateUrl: './ind-ins-interaction.component.html',
  styleUrl: './ind-ins-interaction.component.css'
})
export class IndInsInteractionComponent implements OnInit {
  ...
  load(){
    ...
    this.api.get('Research/ind_ins_interactions').subscribe((res:any)=>{
      this.ind_ins_interactions=res;
      console.log(res)
    })
