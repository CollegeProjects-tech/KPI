...
@Component({
  selector: 'app-aca-gustlec-arranged',
  standalone: true,
  imports: [CommonModule,ReactiveFormsModule],
  templateUrl: './aca-gustlec-arranged.component.html',
  styleUrl: './aca-gustlec-arranged.component.css'
})
export class AcaGustlecArrangedComponent implements OnInit {
  ...
  load(){
    ...
    this.api.get('Research/Acagustlecs').subscribe((res:any)=>{
      this.Acagustlecs=res;
      console.log(res)
    })
